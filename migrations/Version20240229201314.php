 ...
 */
final class Version20240229201314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP favorie');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD favorie TINYINT(1) NOT NULL');
    }
}
