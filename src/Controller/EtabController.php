...
class EtabController extends AbstractController
{
    ...
    public function show(int $id, EtabRepository $etabRepository): Response
    {
        $etab = $etabRepository->find($id);
    ...
    public function edit(Request $request, int $id, EntityManagerInterface $entityManager, EtabRepository $etabRepository): Response
    {
        $etab = $etabRepository->find($id);
    ...
    public function delete(Request $request, int $id, EtabRepository $etabRepository, EntityManagerInterface $entityManager): Response
    {
        $etab = $etabRepository->find($id);
