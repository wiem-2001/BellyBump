...
use App\Repository\VotreRepository;
...
class InfoMedicauxController extends AbstractController
{
    ...
    public function statistics(InfoMedicauxRepository $infoMedicauxRepository, EntityManagerInterface $entityManager): Response
    {
        $queryBuilder = $entityManager->createQueryBuilder();
        
        $data = $queryBuilder->select('v.BloodType')
        ...
        return $this->render('info_medicaux/chart.html.twig', ['data' => $data]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager,Security $security): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_babies_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}/show', name: 'app_info_medicaux_show', methods: ['GET'])]
